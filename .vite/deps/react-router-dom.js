...
var AbortedDeferredError = className extends Error {
};
var DeferredData = className {
...
var ErrorResponseImpl = className {
...
var RenderErrorBoundary = className extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
var AwaitErrorBoundary = className extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      error: null
