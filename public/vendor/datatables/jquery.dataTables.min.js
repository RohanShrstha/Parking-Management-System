...
(function (h) {
  ...
  function gb(a) {
    ...
    A(a, "orderclassNamees", "bSortclassNamees");
  ...
  function la(a, b, c) {
    ...
    c !== k &&
      ...
      c.className && !c.sclassName && (c.sclassName = c.className),
      c.sclassName && e.addclassName(c.sclassName),
      h.extend(b, c),
    ...
    a.oFeatures.bSort || ((b.bSortable = !1), e.addclassName(d.sSortableNone));
    a = -1 !== h.inArray("asc", b.asSorting);
    c = -1 !== h.inArray("desc", b.asSorting);
    !b.bSortable || (!a && !c)
      ? ((b.sSortingclassName = d.sSortableNone), (b.sSortingclassNameJUI = ""))
      : a && !c
      ? ((b.sSortingclassName = d.sSortableAsc),
        (b.sSortingclassNameJUI = d.sSortJUIAscAllowed))
      : !a && c
      ? ((b.sSortingclassName = d.sSortableDesc),
        (b.sSortingclassNameJUI = d.sSortJUIDescAllowed))
      : ((b.sSortingclassName = d.sSortable),
        (b.sSortingclassNameJUI = d.sSortJUI));
  }
  function aa(a) {
        ...
        for (g = q.length; f < g; f++)
          if ("number" === typeof q[f] && 0 <= q[f]) {
            ...
            for (i = m.length; j < i; j++)
              ("_all" == q[f] || h(m[j].nTh).hasclassName(q[f])) && d(j, n);
          }
      }
    if (c) {
      e = 0;
  ...
  function Ja(a, b, c, d) {
    ...
    if (null === e.nTr) {
      ...
      for (m = a.aoColumns.length; n < m; n++) {
        ...
        i.sclassName && (e.className += " " + i.sclassName);
        i.bVisible && !c
          ? j.appendChild(e)
  ...
  function Na(a, b) {
    ...
    if (c) {
      ...
      e && (c.id = e);
      d.DT_RowclassName &&
        ((e = d.DT_RowclassName.split(" ")),
        (b.__rowc = b.__rowc ? ra(b.__rowc.concat(e)) : e),
        h(c)
          .removeclassName(b.__rowc.join(" "))
          .addclassName(d.DT_RowclassName));
  ...
  function mb(a) {
    ...
    for (c = m.length; b < c; b++)
      (f = m[b]),
        (d = h(f.nTh).addclassName(f.sclassName)),
        i && d.appendTo(e),
        a.oFeatures.bSort &&
          (d.addclassName(f.sSortingclassName),
          !1 !== f.bSortable &&
    ...
    h(g).children("tr").children("th, td").addclassName(n.sHeaderTH);
    h(j).children("tr").children("th, td").addclassName(n.sFooterTH);
    if (null !== j) {
      a = a.aoFooter[0];
      b = 0;
      for (c = a.length; b < c; b++)
        (f = m[b]),
          (f.nTf = a[b].cell),
          f.sclassName && h(f.nTf).addclassName(f.sclassName);
    }
  }
  function ga(a, b, c) {
    var d,
      ...
      if (0 !== i.length) {
        ...
        for (j = j ? 0 : g; j < f; j++) {
          ...
          if (0 !== e) {
            var G = d[c % e];
            q._sRowStripe != G &&
              (h(s).removeclassName(q._sRowStripe).addclassName(G),
              (q._sRowStripe = G));
          }
        ...
        (c = f.sZeroRecords),
          ...
          (b[0] = h("<tr/>", { className: e ? d[0] : "" }).append(
            h("<td />", {
              valign: "top",
              colSpan: W(a),
              className: a.oclassNamees.sRowEmpty,
            }).html(c)
          )[0]);
  ...
  function pb(a) {
    var b = a.oclassNamees,
      c = h(a.nTable),
      c = h("<div/>").insertBefore(c),
      d = a.oFeatures,
      e = h("<div/>", {
        id: a.sTableId + "_wrapper",
        className: b.sWrapper + (a.nTFoot ? "" : " " + b.sNoFooter),
      });
    a.nHolding = c[0];
    a.nTableWrapper = e[0];
  ...
  function ub(a) {
    var b = a.sTableId,
      c = a.aanFeatures.i,
      d = h("<div/>", {
        className: a.oclassNamees.sInfo,
        id: !c ? b + "_info" : null,
      });
    c ||
  ...
  function qb(a) {
    ...
    var i = h("<div><label/></div>").addclassName(b.sLength);
  ...
  function vb(a) {
    var b = a.sPaginationType,
      ...
      b = h("<div/>").addclassName(a.oclassNamees.sPaging + b)[0],
      f = a.aanFeatures;
    d || c.fnInit(a, b, e);
    f.p ||
  ...
  function sb(a) {
    return h("<div/>", {
      ...
      className: a.oclassNamees.sProcessing,
    })
  ...
  function tb(a) {
    ...
    var d = c.sX,
      ...
      m = b.children("tfoot");
    m.length || (m = null);
    i = h("<div/>", { className: f.sScrollWrapper })
      .append(
        h("<div/>", { className: f.sScrollHead })
          .css({
            overflow: "hidden",
            position: "relative",
            border: 0,
          ...
          .append(
            h("<div/>", { className: f.sScrollHeadInner })
    ...
    m &&
      i.append(
        h("<div/>", { className: f.sScrollFoot })
          ...
          .append(
            h("<div/>", { className: f.sScrollFootInner }).append(
              n
                .removeAttr("id")
                .css("margin-left", 0)
  ...
  function ya(a) {
    var b = a.aLastSort,
      ...
      f,
      g;
    if (e.bSort && e.bSortclassNamees) {
      e = 0;
      for (f = b.length; e < f; e++)
        (g = b[e].src),
          h(C(a.aoData, "anCells", g)).removeclassName(c + (2 > e ? e + 1 : 3));
      e = 0;
      for (f = d.length; e < f; e++)
        (g = d[e].src),
          h(C(a.aoData, "anCells", g)).addclassName(c + (2 > e ? e + 1 : 3));
    }
    a.aLastSort = d;
  }
  function Jb(a, b) {
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          F(
            p.oFeatures,
            g,
            "bPaginate bLengthChange bFilter bSort bSortMulti bInfo bProcessing bAutoWidth bSortclassNamees bServerSide bDeferRender".split(
              " "
            )
          );
          F(p, g, [
          ...
          p.rowIdFn = S(g.rowId);
          ib(p);
          var u = p.oclassNamees;
          h.extend(u, l.ext.classNamees, g.oclassNamees);
          q.addclassName(u.sTable);
          ...
          w.sUrl
            ? (h.ajax({
              ...
              (n = !0))
            : t(p, null, "i18n", [p]);
          null === g.asStripeclassNamees &&
            (p.asStripeclassNamees = [u.sStripeOdd, u.sStripeEven]);
          var e = p.asStripeclassNamees,
            v = q.children("tbody").find("tr").eq(0);
          -1 !==
            h.inArray(
              !0,
              h.map(e, function (a) {
                return v.hasclassName(a);
              })
            ) &&
            (h("tbody tr", this).removeclassName(e.join(" ")),
      ...
      var d = c[0],
        ...
        f = function (a, b) {
          if (Array.isArray(a) || a instanceof h)
            ...
            c = h("<tr><td></td></tr>").addclassName(b);
            h("td", c).addclassName(b).html(a)[0].colSpan = W(d);
            e.push(c[0]);
          }
        };
      f(a, b);
  ...
  o("destroy()", function (a) {
    ...
    return this.iterator("table", function (b) {
      ...
      b.aaSortingFixed = [];
      ya(b);
      h(m).removeclassName(b.asStripeclassNamees.join(" "));
      h("th, td", g).removeclassName(
        d.sSortable +
          " " +
          d.sSortableAsc +
          " " +
      ...
      if (!a && c) {
        ...
        i.css("width", b.sDestroyWidth).removeclassName(d.sTable);
        (o = b.asDestroyStripes.length) &&
          f.children().each(function (a) {
            h(this).addclassName(b.asDestroyStripes[a % o]);
          });
      }
  ...
  h.extend(v, {
    ...
    oApi: v.internal,
    oStdclassNamees: v.classNamees,
    oPagination: v.pager,
  });
  h.extend(l.ext.classNamees, {
    sTable: "dataTable",
    sNoFooter: "no-footer",
    ...
    header: {
      _: function (a, b, c, d) {
        h(a.nTable).on("order.dt.DT", function (e, f, g, h) {
          if (a === f) {
            e = c.idx;
            b.removeclassName(d.sSortAsc + " " + d.sSortDesc).addclassName(
              h[e] == "asc"
                ? d.sSortAsc
                : h[e] == "desc"
                ? d.sSortDesc
      ...
      jqueryui: function (a, b, c, d) {
        h("<div/>")
          .addclassName(d.sSortJUIWrapper)
          .append(b.contents())
          .append(
            h("<span/>").addclassName(
              d.sSortIcon + " " + c.sSortingclassNameJUI
            )
          )
          .appendTo(b);
        h(a.nTable).on("order.dt.DT", function (e, f, g, h) {
