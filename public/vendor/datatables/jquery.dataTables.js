...
(function (factory) {
  ...
  var DataTable = function (options) {
    ...
    this.fnOpen = function (nTr, mHtml, sclassName) {
      return this.api(true).row(nTr).child(mHtml, sclassName).show().child()[0];
    };
    ...
    this.each(function () {
      ...
      if (
        $.inArray(
          true,
          $.map(stripeclassNamees, function (el, i) {
  ...
  function _fnColumnOptions(oSettings, iCol, oOptions) {
    ...
    if (oOptions !== undefined && oOptions !== null) {
      ...
      if (oOptions.className && !oOptions.sclassName) {
        oOptions.sclassName = oOptions.className;
      }
  ...
  function _fnBuildHead(oSettings) {
    ...
    for (i = 0, ien = columns.length; i < ien; i++) {
      ...
      _fnRenderer(oSettings, "header")(oSettings, cell, column, classNamees);
    }
    ...
    $(thead)
      .children("tr")
      .children("th, td")
      .addclassName(classNamees.sHeaderTH);
    $(tfoot)
      .children("tr")
      .children("th, td")
      .addclassName(classNamees.sFooterTH);
  ...
  function _fnDraw(oSettings) {
    ...
    if (aiDisplay.length !== 0) {
      ...
      anRows[0] = $("<tr/>", {
        className: iStripes ? asStripeclassNamees[0] : "",
      }).append(
        $("<td />", {
          valign: "top",
  ...
  function _fnAddOptionsHtml(oSettings) {
    ...
    var insert = $("<div/>", {
      ...
      className:
        classNamees.sWrapper +
        (oSettings.nTFoot ? "" : " " + classNamees.sNoFooter),
    });
  ...
  function _fnFeatureHtmlFilter(settings) {
    ...
    var input =
      '<input type="search" className="' + classNamees.sFilterInput + '"/>';
    ...
    if (footer) {
      scroller.append(
        $(_div, { className: classNamees.sScrollFoot })
          ...
          .append(
            $(_div, { className: classNamees.sScrollFootInner }).append(
              footerClone
                .removeAttr("id")
                .css("margin-left", 0)
  ...
  function _fnScrollDraw(settings) {
    ...
    _fnApplyToChildren(function (nSizer, i) {
      nSizer.innerHTML =
        '<div className="dataTables_sizing">' + headerContent[i] + "</div>";
    ...
    if (footer) {
      _fnApplyToChildren(function (nSizer, i) {
        nSizer.innerHTML =
          '<div className="dataTables_sizing">' + footerContent[i] + "</div>";
        nSizer.childNodes[0].style.height = "0";
        nSizer.childNodes[0].style.overflow = "hidden";
  ...
  function _fnSortingclassNamees(settings) {
    ...
    if (features.bSort && features.bSortclassNamees) {
      ...
      for (i = 0, ien = oldSort.length; i < ien; i++) {
        ...
        $(_pluck(settings.aoData, "anCells", colIdx)).removeclassName(
          sortclassName + (i < 2 ? i + 1 : 3)
        );
      }
      ...
      for (i = 0, ien = sort.length; i < ien; i++) {
        ...
        $(_pluck(settings.aoData, "anCells", colIdx)).addclassName(
          sortclassName + (i < 2 ? i + 1 : 3)
        );
      }
    }
  ...
  var __details_add = function (ctx, row, data, klass) {
    ...
    var addRow = function (r, k) {
      ...
      if (r.nodeName && r.nodeName.toLowerCase() === "tr") {
        ...
        $("td", created).addclassName(k).html(r)[0].colSpan =
  ...
  _api_register("destroy()", function (remove) {
    ...
    return this.iterator("table", function (settings) {
      ...
      $("th, td", thead).removeclassName(
        classNamees.sSortable +
          " " +
          classNamees.sSortableAsc +
          " " +
          classNamees.sSortableDesc +
          " " +
          classNamees.sSortableNone
      );
            ...
            if (Array.isArray(button)) {
              ...
              switch (button) {
                ...
                default:
                  ...
                  btnclassName =
                    page === button ? classNamees.sPageButtonActive : "";
                  break;
              }
    ...
    header: {
      _: function (settings, cell, column, classNamees) {
        ...
        $(settings.nTable).on(
          ...
          function (e, ctx, sorting, columns) {
            ...
            cell
              .removeclassName(
                classNamees.sSortAsc + " " + classNamees.sSortDesc
              )
              .addclassName(
                columns[colIdx] == "asc"
      ...
      jqueryui: function (settings, cell, column, classNamees) {
        $("<div/>")
          ...
          .append(
            $("<span/>").addclassName(
              classNamees.sSortIcon + " " + column.sSortingclassNameJUI
            )
          )
          .appendTo(cell);
