...
(function (global, factory) {
  ...
  var Button = /*#__PURE__*/ (function () {
    ...
    _proto.toggle = function toggle() {
        ...
        if (input) {
          ...
          if (triggerChangeEvent) {
            ...
            if (input.type === "checkbox" || input.type === "radio") {
              input.checked = !this._element.classNameList.contains(
                className_NAME_ACTIVE
              );
            }
      ...
      if (
        ...
        if (triggerChangeEvent) {
          $__default["default"](this._element).toggleclassName(
            className_NAME_ACTIVE
          );
        }
      }
  ...
  $__default["default"](document)
    .on(EVENT_CLICK_DATA_API$1, SELECTOR_DATA_TOGGLE_CARROT, function (event) {
      ...
      if (
        ...
        button.classNameList.contains("disabled")
      ) {
        ...
        if (
          ...
          (inputBtn.hasAttribute("disabled") ||
            inputBtn.classNameList.contains("disabled"))
        ) {
          event.preventDefault(); // work around Firefox bug #1540995
    ...
    .on(
      ...
      function (event) {
        ...
        $__default["default"](button).toggleclassName(
          className_NAME_FOCUS,
  ...
  var Carousel = /*#__PURE__*/ (function () {
    ...
    _proto._setActiveIndicatorElement = function _setActiveIndicatorElement(
      ...
      if (this._indicatorsElement) {
        ...
        $__default["default"](indicators).removeclassName(
        ...
        if (nextIndicator) {
          $__default["default"](nextIndicator).addclassName(
            className_NAME_ACTIVE$1
          );
        }
      }
    ...
    _proto._slide = function _slide(direction, element) {
      ...
      if (
        nextElement &&
        $__default["default"](nextElement).hasclassName(className_NAME_ACTIVE$1)
      ) {
        this._isSliding = false;
        return;
      }
    ...
    Carousel._dataApiClickHandler = function _dataApiClickHandler(event) {
      ...
      if (
        !target ||
        !$__default["default"](target).hasclassName(className_NAME_CAROUSEL)
      ) {
        return;
      }
  ...
  var Collapse = /*#__PURE__*/ (function () {
    ...
    _proto.toggle = function toggle() {
      if (
        $__default["default"](this._element).hasclassName(className_NAME_SHOW$1)
      ) {
        this.hide();
      } else {
        this.show();
    ...
    _proto.show = function show() {
      ...
      $__default["default"](this._element)
        .removeclassName(className_NAME_COLLAPSE)
        .addclassName(className_NAME_COLLAPSING);
      this._element.style[dimension] = 0;

      if (this._triggerArray.length) {
        $__default["default"](this._triggerArray)
          .removeclassName(className_NAME_COLLAPSED)
      ...
      var complete = function complete() {
        $__default["default"](_this._element)
          .removeclassName(className_NAME_COLLAPSING)
          .addclassName(className_NAME_COLLAPSE + " " + className_NAME_SHOW$1);
    ...
    _proto.hide = function hide() {
      ...
      if (
        this._isTransitioning ||
        !$__default["default"](this._element).hasclassName(
          className_NAME_SHOW$1
        )
      ) {
        return;
      }
      ...
      $__default["default"](this._element)
        .addclassName(className_NAME_COLLAPSING)
        .removeclassName(className_NAME_COLLAPSE + " " + className_NAME_SHOW$1);
          ...
          if (selector !== null) {
            ...
            if (!$elem.hasclassName(className_NAME_SHOW$1)) {
              $__default["default"](trigger)
                .addclassName(className_NAME_COLLAPSED)
      ...
      var complete = function complete() {
        ...
        $__default["default"](_this2._element)
          .removeclassName(className_NAME_COLLAPSING)
          .addclassName(className_NAME_COLLAPSE)
    ...
    _proto._getDimension = function _getDimension() {
      var hasWidth = $__default["default"](this._element).hasclassName(
        DIMENSION_WIDTH
      );
    ...
    _proto._getParent = function _getParent() {
      ...
      $__default["default"](children).each(function (i, element) {
        _this3._addAriaAndCollapsedclassName(
    ...
    _proto._addAriaAndCollapsedclassName =
      function _addAriaAndCollapsedclassName(element, triggerArray) {
        var isOpen = $__default["default"](element).hasclassName(
          className_NAME_SHOW$1
        );

        if (triggerArray.length) {
          $__default["default"](triggerArray)
            .toggleclassName(className_NAME_COLLAPSED, !isOpen)
  ...
  var Dropdown = /*#__PURE__*/ (function () {
    ...
    _proto.toggle = function toggle() {
      if (
        ...
        $__default["default"](this._element).hasclassName(
          className_NAME_DISABLED
        )
      ) {
        return;
      }

      var isActive = $__default["default"](this._menu).hasclassName(
        className_NAME_SHOW$2
      );
    ...
    _proto.show = function show(usePopper) {
      ...
      if (
        ...
        $__default["default"](this._menu).hasclassName(className_NAME_SHOW$2)
      ) {
        return;
      }
      ...
      if (!this._inNavbar && usePopper) {
        ...
        if (this._config.boundary !== "scrollParent") {
          $__default["default"](parent).addclassName(
            className_NAME_POSITION_STATIC
          );
        }
      ...
      $__default["default"](parent)
        .toggleclassName(className_NAME_SHOW$2)
    ...
    _proto._getPlacement = function _getPlacement() {
      ...
      if ($parentDropdown.hasclassName(className_NAME_DROPUP)) {
        placement = $__default["default"](this._menu).hasclassName(
          className_NAME_MENURIGHT
        )
          ? PLACEMENT_TOPEND
          : PLACEMENT_TOP;
        ...
        $__default["default"](this._menu).hasclassName(className_NAME_MENURIGHT)
      ) {
    ...
    Dropdown._clearMenus = function _clearMenus(event) {
      ...
      for (var i = 0, len = toggles.length; i < len; i++) {
        ...
        if (
          !$__default["default"](parent).hasclassName(className_NAME_SHOW$2)
        ) {
          continue;
        }
        ...
        $__default["default"](dropdownMenu).removeclassName(
          className_NAME_SHOW$2
        );
        $__default["default"](parent)
          .removeclassName(className_NAME_SHOW$2)
          .trigger($__default["default"].Event(EVENT_HIDDEN$1, relatedTarget));
      }
    };
    ...
    Dropdown._dataApiKeydownHandler = function _dataApiKeydownHandler(event) {
      ...
      if (
        this.disabled ||
        $__default["default"](this).hasclassName(className_NAME_DISABLED)
      ) {
        return;
      }
      ...
      var isActive = $__default["default"](parent).hasclassName(
        className_NAME_SHOW$2
      );
  ...
  var Modal = /*#__PURE__*/ (function () {
    ...
    _proto.show = function show(relatedTarget) {
      ...
      if (
        $__default["default"](this._element).hasclassName(className_NAME_FADE$1)
      ) {
    ...
    _proto.hide = function hide(event) {
      ...
      this._isShown = false;
      var transition = $__default["default"](this._element).hasclassName(
        className_NAME_FADE$1
      );
      ...
      $__default["default"](this._element).removeclassName(
        className_NAME_SHOW$3
      );
    ...
    _proto._showElement = function _showElement(relatedTarget) {
      ...
      if (
        $__default["default"](this._dialog).hasclassName(
          className_NAME_SCROLLABLE
        ) &&
        modalBody
      ) {
    ...
    _proto._hideModal = function _hideModal() {
      ...
      this._showBackdrop(function () {
        $__default["default"](document.body).removeclassName(
          className_NAME_OPEN
        );
    ...
    _proto._showBackdrop = function _showBackdrop(callback) {
      ...
      var animate = $__default["default"](this._element).hasclassName(
        className_NAME_FADE$1
      )
        ? className_NAME_FADE$1
        : "";
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        $__default["default"](this._backdrop).addclassName(
          className_NAME_SHOW$3
        );
        ...
        $__default["default"](this._backdrop).removeclassName(
          className_NAME_SHOW$3
        );
  ...
  var Tooltip = /*#__PURE__*/ (function () {
    ...
    _proto.toggle = function toggle(event) {
      ...
      if (event) {
        ...
        if (
          $__default["default"](this.getTipElement()).hasclassName(
            className_NAME_SHOW$4
          )
        ) {
    ...
    _proto.show = function show() {
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        if (
          $__default["default"](this.tip).hasclassName(className_NAME_FADE$2)
        ) {
          var transitionDuration = Util.getTransitionDurationFromElement(
            this.tip
          );
    ...
    _proto.addAttachmentclassName = function addAttachmentclassName(
      attachment
    ) {
      $__default["default"](this.getTipElement()).addclassName(
        className_PREFIX + "-" + attachment
      );
    };
    ...
    _proto.setContent = function setContent() {
      ...
      $__default["default"](tip).removeclassName(
        className_NAME_FADE$2 + " " + className_NAME_SHOW$4
      );
    };
    ...
    _proto._enter = function _enter(event, context) {
      ...
      if (
        $__default["default"](context.getTipElement()).hasclassName(
          className_NAME_SHOW$4
        ) ||
    ...
    _proto._activate = function _activate(target) {
      ...
      if ($link.hasclassName(className_NAME_DROPDOWN_ITEM)) {
        $link
          ...
          .addclassName(className_NAME_ACTIVE$2);
        ...
        $link
          ...
          .addclassName(className_NAME_ACTIVE$2); // Handle special case when .nav-link is inside .nav-item
  ...
  var Tab = /*#__PURE__*/ (function () {
    ...
    _proto.show = function show() {
      ...
      if (
        (this._element.parentNode &&
          this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
          $__default["default"](this._element).hasclassName(
            className_NAME_ACTIVE$3
          )) ||
        $__default["default"](this._element).hasclassName(
          className_NAME_DISABLED$1
        )
      ) {
        return;
      }
    ...
    _proto._activate = function _activate(element, container, callback) {
      ...
      var isTransitioning =
        callback &&
        active &&
        $__default["default"](active).hasclassName(className_NAME_FADE$4);
      ...
      if (active && isTransitioning) {
        ...
        $__default["default"](active)
          .removeclassName(className_NAME_SHOW$6)
          .one(Util.TRANSITION_END, complete)
          .emulateTransitionEnd(transitionDuration);
      } else {
        complete();
    ...
    _proto._transitionComplete = function _transitionComplete(
      ...
      if (active) {
        ...
        if (dropdownChild) {
          $__default["default"](dropdownChild).removeclassName(
            className_NAME_ACTIVE$3
          );
        }
      ...
      if (
        element.parentNode &&
        $__default["default"](element.parentNode).hasclassName(
          className_NAME_DROPDOWN_MENU
        )
      ) {
        var dropdownElement =
        ...
        if (dropdownElement) {
          ...
          $__default["default"](dropdownToggleList).addclassName(
            className_NAME_ACTIVE$3
          );
        }
