...
!(function () {
  ...
  function Ct(t) {
    return t.classNameList
      ? At(t.classNameList)
      : (t.getAttribute("className") || "").split(" ").filter(function (t) {
          return t;
        });
  }
  function Ot(t, e) {
  ...
  function jt(t) {
    var e = t.icons,
      ...
      y = [
        et.replacementclassName,
        i ? "".concat(et.familyPrefix, "-").concat(i) : "",
        b,
      ]
        .filter(function (t) {
          return -1 === u.classNamees.indexOf(t);
        })
        .filter(function (t) {
          return "" !== t || !!t;
        })
        .concat(u.classNamees)
        .join(" "),
      w = {
        children: [],
  ...
  var ee = {
    ...
    nest: function (t) {
      var e = t[0],
        n = t[1];
      if (~Ct(e).indexOf(et.replacementclassName)) return ee.replace(t);
      var a = new RegExp("".concat(et.familyPrefix, "-.*"));
      delete n[0].attributes.style, delete n[0].attributes.id;
      var r = n[0].attributes.className.split(" ").reduce(
        function (t, e) {
          return (
            e === et.replacementclassName || e.match(a)
              ? t.toSvg.push(e)
              : t.toNode.push(e),
            t
          );
      ...
      var i = n
        ...
        .join("\n");
      e.setAttribute("className", r.toNode.join(" ")),
        e.setAttribute(tt, ""),
        (e.innerHTML = i);
    },
  };
  ...
  function fe(t) {
    var e,
      ...
      g =
        ...
        et.autoA11y &&
          (o
            ? (i["aria-labelledby"] = ""
                .concat(et.replacementclassName, "-title-")
                .concat(c || kt()))
    ...
    return {
      ...
      extra: { classNamees: d, styles: m, attributes: g },
    };
  }
  function ue(t) {
    ...
    return {
      ...
      icon: Array.isArray(a)
        ? {
            tag: "g",
            attributes: {
              className: "".concat(et.familyPrefix, "-").concat(Y.GROUP),
            },
            children: [
              {
                tag: "path",
              ...
              },
              {
                tag: "path",
                attributes: {
                  className: "".concat(et.familyPrefix, "-").concat(Y.PRIMARY),
                  fill: "currentColor",
                  d: a[1],
                },
              },
  ...
  function xe(t) {
    var i,
      ...
      m,
      a = fe(t);
    return ~a.extra.classNamees.indexOf(j)
      ? (function (t, e) {
          var n = e.title,
            a = e.transform,
            r = e.extra,
  ...
  function ke(t) {
    ...
    if (m) {
      var e = b.documentElement.classNameList,
        a = function (t) {
      ...
      if (r && "none" !== o && "" !== o) {
        ...
        if (!f || (e && e.getAttribute(C) === s && e.getAttribute(O) === u))
          ...
          var d = {
              ...
              mask: null,
              maskId: null,
              extra: { classNamees: [], styles: {}, attributes: {} },
            },
            m = d.extra;
          (m.attributes[w] = h),
            ye(f, s)
          ...
          return Ee($({ type: "icon" }, t), function () {
            return (
              ...
              jt({
                ...
                maskId: l,
                titleId: m,
                extra: { attributes: v, styles: y, classNamees: h },
              })
            );
          });
        }
            ...
            [
              {
                tag: "span",
                attributes: {
                  className: ["".concat(et.familyPrefix, "-layers")]
                    .concat(d(n))
                    .join(" "),
                },
                children: e,
