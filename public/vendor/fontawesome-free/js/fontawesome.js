...
(function () {
  ...
  if (DOCUMENT && typeof DOCUMENT.querySelector === "function") {
    var attrs = [
      ...
      ["data-replacement-className", "replacementclassName"],
  ...
  function makeInlineSvgAbstract(params) {
    ...
    var widthclassName = isUploadedIcon
      ? ""
      : "fa-w-".concat(Math.ceil((width / height) * 16));
    var attrclassName = [
      config.replacementclassName,
    ...
    var uploadedIconWidthStyle =
      isUploadedIcon && !~extra.classNamees.indexOf("fa-fw")
        ? {
  ...
  function getCanonicalIcon(values) {
    return values.reduce(function (acc, cls) {
      ...
      if (styles$1[cls]) {
        ...
        cls !== config.replacementclassName &&
        cls.indexOf("fa-w-") !== 0
      ) {
        acc.rest.push(cls);
      }
  ...
  var mutators = {
    ...
    nest: function nest(mutation) {
      ...
      var splitclassNamees = abstract[0].attributes.className.split(" ").reduce(
        function (acc, cls) {
        ...
        if (
          ...
          if (mutationRecord.attributeName === "className") {
            var _getCanonicalIcon = getCanonicalIcon(
                classNameArray(mutationRecord.target)
              ),
    ...
    if (config.autoA11y) {
      if (title) {
        extraAttributes["aria-labelledby"] = ""
          .concat(config.replacementclassName, "-title-")
    ...
    if (Array.isArray(vectorData)) {
      element = {
        ...
        attributes: {
          className: ""
            .concat(config.familyPrefix, "-")
            .concat(DUOTONE_classNameES.GROUP),
        },
        children: [
          {
            tag: "path",
            attributes: {
              className: ""
                .concat(config.familyPrefix, "-")
                .concat(DUOTONE_classNameES.SECONDARY),
              fill: "currentColor",
              d: vectorData[0],
            },
          },
          {
            ...
            attributes: {
              className: ""
                .concat(config.familyPrefix, "-")
                .concat(DUOTONE_classNameES.PRIMARY),
              fill: "currentColor",
              d: vectorData[1],
            },
          },
  ...
  function onTree(root) {
    ...
    var hclAdd = function hclAdd(suffix) {
      return htmlclassNameList.add(
        "".concat(HTML_className_I2SVG_BASE_className, "-").concat(suffix)
      );
    };

    var hclRemove = function hclRemove(suffix) {
      return htmlclassNameList.remove(
        "".concat(HTML_className_I2SVG_BASE_className, "-").concat(suffix)
      );
    };
    ...
    var prefixesDomQuery = [
      "."
        .concat(LAYERS_TEXT_classNameNAME, ":not([")
      ...
      function () {
        ...
        return makeLayersTextAbstract({
          ...
          extra: {
            ...
            ].concat(_toConsumableArray(classNamees)),
          },
        });
      }
    );
        ...
        return [
          {
            tag: "span",
            attributes: {
              className: ["".concat(config.familyPrefix, "-layers")]
                .concat(_toConsumableArray(classNamees))
                .join(" "),
            },
            children: children,
